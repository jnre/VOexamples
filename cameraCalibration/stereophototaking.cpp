...
int main(int argc, char** argv)
{
    ...
    for(;;)
    {
        ...
        if( c == 's'){        //keypress s to take photos
            ...
            char filename0[100];
            char filename1[100];
            sprintf(filename0,"/home/joseph/VOexamples/cameraCalibration/left%02d.jpg",*pt_i);
            sprintf(filename1,"/home/joseph/VOexamples/cameraCalibration/right%02d.jpg",*pt_i);
